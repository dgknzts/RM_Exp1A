...
my_data <- readxl::read_excel('exp1_df.xlsx')
...
# adjustment_duration < 1 = 455 Trials. Mostly Participant 8.
# adjustment_duration > 15= 12 trials
# number response > 10 = 5 trials.
# number dev > 4 = 1 trials
...
my_plot1.0.0 <-  ggplot() +
  ...
  scale_color_manual(
    labels = c("0.25deg", "0.40deg", "0.55deg"),
    values = c( "#5E4C5F", "#EA801C", "#1A80BB"),
    name = "Line width"
  ) +
  ...
  facet_wrap(~ spacing, labeller = labeller(
    spacing =
      c(
        "small" = "Spacing 0.7deg",
        "middle" = "Spacing 0.9deg",
        "large" = "Spacing 1.1deg"
      ))
  )
...
# remove overestimation trials 3584 to 3279
my_data <- my_data %>% 
...
my_plot3.0 <-  ggplot() +
  ...
  labs(y = "Width deviation (deg)", x = "Set size") +
...
my_plot5.0 <-  ggplot() +
  ...
  labs(y = "Spacing deviation (deg)", x = "Set size") +
...
ggsave(file = "1.1.0.png", plot = my_plot1.1.0, width = 8.47, height = 3.79, units = "in")
 ...
 ggsave(file = "3.2.0.png", plot = my_plot3.2.0, width = 10, height = 4.6, units = "in")
 
 
 ggsave(file = "3.3.png", plot = my_plot3.3, width = 8.27, height = 6.66, units = "in")

 
 ggsave(file = "4.0.png", plot = my_plot4.0, width = 10, height = 3.79, units = "in")
 ggsave(file = "4.1.png", plot = my_plot4.1, width = 10, height = 3.79, units = "in")
